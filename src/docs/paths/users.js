/**
 * @fileoverview User API Documentation
 * @module docs/paths/users
 */
 ...
 *     description: Get the current user's full profile with associated data
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *     description: Update basic information for the current user
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Get platform-wide user statistics (Admin only)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *     description: Get a specific user by their ID (Admin or self)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Temporarily suspend a user's account (Admin only)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   post:
 *     summary: Ban a user
 *     description: Permanently ban a user's account (Admin only)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Reactivate a suspended or banned user (Admin only)
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
